...
@section('content')
    ...
    <div x-data="groupForm()" :class="{ 'dark-mode': $store.darkMode.isDark }" class="max-w-4xl mx-auto p-6 relative">
        <div class="sticky top-0 z-20 bg-white shadow-md p-4 rounded-lg mb-8 flex justify-center items-center animate-slide-in dark:bg-gray-800">
            <h2 class="text-3xl font-bold text-gray-800 animate-pulse dark:text-gray-200">Edit Group</h2>
        </div>
        ...
        <div class="flex justify-center">
            <div class="w-full md:w-3/4">
                <div class="bg-white p-6 rounded-lg shadow-lg animate-glow dark:bg-gray-700">
                    ...
                    <form action="{{ route('groups.update', $group->id) }}" method="POST" x-ref="form" @submit="submitForm">
                        @csrf
                        @method('PATCH')
                        ...
                        <div x-show="step === 1" class="animate-slide-in">
                            <div class="mb-6">
                                <label for="name" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    ...
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Enter the group name</span>
                                </label>
                                <input
                                    type="text"
                                    id="name"
                            ...
                            <div class="mb-6">
                                <label for="manager_id" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    Manager
                                    <i class="fas fa-info-circle ml-1 text-gray-500 cursor-pointer dark:text-gray-400"></i>
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Select the group manager</span>
                                </label>
                                <select
                                    id="manager_id"
                                    name="manager_id"
                        ...
                        <div x-show="step === 2" class="animate-slide-in">
                            ...
                            <div class="mb-4 p-4 bg-gray-100 rounded-lg dark:bg-gray-700">
                                <p><strong class="text-gray-700 dark:text-gray-300">Name:</strong> <span x-text="form.name || 'Not provided'" class="text-gray-900 dark:text-white"></span></p>
                                <p><strong class="text-gray-700 dark:text-gray-300">Manager:</strong> <span x-text="form.manager_id ? document.querySelector(`select[name=manager_id] option[value=${form.manager_id}]`).text : 'None'" class="text-gray-900 dark:text-white"></span></p>
                            </div>
                            <div class="button-container">
                                <button
                                    type="button"
