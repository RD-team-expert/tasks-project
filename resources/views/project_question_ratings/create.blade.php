<div class="container">
    <h2>Create project_question_ratings</h2>
    <form action="{{ route('project_question_ratings.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label for="project_rating_id" class="form-label">project_rating_id</label>
            <input type="text" class="form-control" name="project_rating_id" value="{{old("project_rating_id")}}">
