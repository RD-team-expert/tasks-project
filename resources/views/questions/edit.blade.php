...
@section('content')
    <div x-data="questionForm()" class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h2 class="text-3xl font-bold mb-4 text-black">Edit Question</h2>
        <p class="text-gray-600 mb-8">Update the details for the question</p>
        ...
        <!-- Form -->
        <form action="{{ route('questions.update', $question->id) }}" method="POST" x-ref="form">
            @csrf
            @method('PATCH')
            ...
            <div x-show="step === 1">
                ...
                <div class="mb-6">
                    <label for="text" class="block text-sm font-semibold text-gray-600 mb-2">
                        ...
                        <span class="inline-block ml-1 text-gray-400 cursor-pointer" title="Update the question text">
