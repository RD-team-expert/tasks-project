...
@section('content')
    ...
    <div x-data="userForm()" :class="{ 'dark-mode': $store.darkMode.isDark }" class="max-w-4xl mx-auto p-6 relative">
        <div class="sticky top-0 z-20 bg-white shadow-md p-4 rounded-lg mb-8 flex justify-center items-center animate-slide-in dark:bg-gray-800">
            <h2 class="text-3xl font-bold text-gray-800 animate-pulse dark:text-gray-200">Create New User</h2>
        </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg animate-glow dark:bg-gray-700">
                    <div class="mb-8 md:hidden">
                        <div class="flex justify-between mb-2 text-sm">
                            ...
                            <div :class="{ 'text-[#8B2BE2] font-bold': step >= 2 }">Role</div>
                            <div :class="{ 'text-[#8B2BE2] font-bold': step >= 3 }">Assignments</div>
                            <div :class="{ 'text-[#8B2BE2] font-bold': step >= 4 }">Review</div>
                        </div>
                    ...
                    <form action="{{ route('users.store') }}" method="POST" x-ref="form" @submit="submitForm">
                        @csrf

                        <div x-show="step === 1" class="animate-slide-in">
                            <div class="mb-6">
                                <label for="username" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    Username <span class="text-red-500">*</span>
                                    <i class="fas fa-info-circle ml-1 text-gray-500 cursor-pointer dark:text-gray-400"></i>
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Enter a unique username</span>
                                </label>
                                <input
                                    type="text"
                                    id="username"
                                    ...
                                    :class="{ 'border-red-500 animate-shake': errors.username }"
                                    required
                                >
                                <p x-show="errors.username" class="text-red-500 text-sm mt-1" x-text="errors.username"></p>
                            </div>
                            <div class="mb-6">
                                <label for="email" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    Email <span class="text-red-500">*</span>
                                    <i class="fas fa-info-circle ml-1 text-gray-500 cursor-pointer dark:text-gray-400"></i>
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Enter the user's email address</span>
                                </label>
                                <input
                                    type="email"
                                    id="email"
                                    ...
                                    class="w-full px-4 py-2 border rounded-lg input-focus dark:bg-gray-800 dark:border-gray-600 dark:text-white"
                                    :class="{ 'border-red-500 animate-shake': errors.email }"
                                    required
                                >
                                <p x-show="errors.email" class="text-red-500 text-sm mt-1" x-text="errors.email"></p>
                            </div>
                            <div class="mb-6">
                                <label for="password" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    Password <span class="text-red-500">*</span>
                                    <i class="fas fa-info-circle ml-1 text-gray-500 cursor-pointer dark:text-gray-400"></i>
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Minimum 8 characters</span>
                                </label>
                                <input
                                    type="password"
                                    id="password"
                                    ...
                                    class="w-full px-4 py-2 border rounded-lg input-focus dark:bg-gray-800 dark:border-gray-600 dark:text-white"
                                    :class="{ 'border-red-500 animate-shake': errors.password }"
                                    required
                                >
                        ...
                        <div x-show="step === 2" class="animate-slide-in">
                            <div class="mb-6">
                                <label for="role" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    Role <span class="text-red-500">*</span>
                                    <i class="fas fa-info-circle ml-1 text-gray-500 cursor-pointer dark:text-gray-400"></i>
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Select the user's role</span>
                                </label>
                                <select
                                    id="role"
                                    name="role"
                                    ...
                                    @change="validateRole"
                                    class="w-full px-4 py-2 border rounded-lg input-focus dark:bg-gray-800 dark:border-gray-600 dark:text-white"
                                    :class="{ 'border-red-500 animate-shake': errors.role }"
                                    required
                                >
                        ...
                        <div x-show="step === 3" class="animate-slide-in">
                            <div class="mb-6">
                                <label for="manager_id" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    ...
                                    <i class="fas fa-info-circle ml-1 text-gray-500 cursor-pointer dark:text-gray-400"></i>
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Assign a manager to the user</span>
                                </label>
                                <select
                                    id="manager_id"
                                    name="manager_id"
                            ...
                            <div class="mb-6">
                                <label for="group_id" class="block text-sm font-semibold text-gray-700 mb-1 relative tooltip-parent dark:text-gray-200">
                                    Assign Group (Optional)
                                    <i class="fas fa-info-circle ml-1 text-gray-500 cursor-pointer dark:text-gray-400"></i>
                                    <span class="tooltip absolute bg-gray-800 text-white text-xs rounded p-2 mt-2 dark:bg-gray-700">Assign the user to a group</span>
                                </label>
                                <select
                                    id="group_id"
                                    name="group_id"
                        ...
                        <div x-show="step === 4" class="animate-slide-in">
                            <h3 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Review Your User</h3>
                            <div class="mb-4 p-4 bg-gray-100 rounded-lg dark:bg-gray-700">
                                <p><strong class="text-gray-700 dark:text-gray-300">Username:</strong> <span x-text="form.username || 'Not provided'" class="text-gray-900 dark:text-white"></span></p>
                                <p><strong class="text-gray-700 dark:text-gray-300">Email:</strong> <span x-text="form.email || 'Not provided'" class="text-gray-900 dark:text-white"></span></p>
                                <p><strong class="text-gray-700 dark:text-gray-300">Password:</strong> <span x-text="form.password ? '********' : 'Not provided'" class="text-gray-900 dark:text-white"></span></p>
                                <p><strong class="text-gray-700 dark:text-gray-300">Role:</strong> <span x-text="form.role || 'Not selected'" class="text-gray-900 dark:text-white"></span></p>
                                <p><strong class="text-gray-700 dark:text-gray-300">Manager:</strong> <span x-text="form.manager_id ? $refs.form.querySelector(`#manager_id option[value='${form.manager_id}']`)?.text || 'Not assigned' : 'Not assigned'" class="text-gray-900 dark:text-white"></span></p>
                                <p><strong class="text-gray-700 dark:text-gray-300">Group:</strong> <span x-text="form.group_id ? $refs.form.querySelector(`#group_id option[value='${form.group_id}']`)?.text || 'Not assigned' : 'Not assigned'" class="text-gray-900 dark:text-white"></span></p>
                            </div>
                            <div class="button-container">
                                <button
                                    type="button"
