...
@section('content')
    ...
    <div x-data="userForm()" :class="{ 'dark-mode': $store.darkMode.isDark }" class="max-w-4xl mx-auto p-6 relative">
        <div class="sticky top-0 z-20 bg-white shadow-md p-4 rounded-lg mb-8 flex justify-center items-center animate-slide-in dark:bg-gray-800">
            <h2 class="text-3xl font-bold text-gray-800 animate-pulse dark:text-gray-200">Edit User</h2>
        </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg animate-glow dark:bg-gray-700">
                    <div class="mb-8 md:hidden">
                        <div class="flex justify-between mb-2 text-sm">
                            <div :class="{ 'text-[#8B2BE2] font-bold': step >= 1 }">User Info</div>
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST" x-ref="form" @submit="submitForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div x-show="step === 2" class="animate-slide-in">
                            ...
                            <div class="mb-4 p-4 bg-gray-100 rounded-lg dark:bg-gray-700">
                                <p><strong class="text-serif text-gray-700 dark:text-gray-300">Username:</strong> <span x-text="form.username || 'Not provided'" class="text-gray-900 dark:text-white"></span></p>
        ...
        function userForm() {
            return {
                ...
                nextStep() {
                    ...
                    this.validateEmail();
                    if (this.errors.username || this.errors.email) return;
                    this.step++;
                },
                prevStep() {
